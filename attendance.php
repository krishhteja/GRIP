...
include_once 'includesatten/functions.php';
sec_session_start();
...
<table width="200" border="0" align="center" cellpadding="2" cellspacing="5">
	...
	?> 
        <form action="includesatten/process_login.php" method="post" name="login_form">                  
<tr><td>Department: </td><td>
<select id = "dept" name = "dept" />
<option value = 'A01'>CE</option>
<option value = 'A02'>EEE</option>
<option value = 'A03'>ECE</option>
<option value = 'A05'>CSE</option>
<option value = 'A12'>IT</option>
<option value = 'A11'>BT</option>
<option value = 'A23'>BME</option>
</select>
</td></tr>           
