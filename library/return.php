...
<div class="wrapper row3">
  <div class="rnd">
    ...
    <input type="text" name="book" value="" size="50" />
    <input type="submit" name="return" value="return" />
    </form>
<?php
	if(isset($_POST['return'])){
		$a = $_POST['book'];
		$ret = mysql_query("DELETE from libissueret WHERE accno = '$a'");
		$update = mysql_query("update books set status = 'available' where accno = '$a'");
		if($ret && $update){
			echo "Book Returned";
		}
	}
