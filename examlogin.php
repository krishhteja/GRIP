<?php
include_once 'includesexam/db_connect.php';
include_once 'includesexam/functions.php';
sec_session_start();
if(!empty($_SESSION['username'])){
	if(substr($_SESSION['username'], 0, 4) == 'eadm')
		header("Location:exam1/admin/date_duties.php");
	if(substr($_SESSION['username'], 0, 1) == 'f')
		header("Location:exam1/faculty.php");
...
<div class="wrapper row3">
  ...
  <!-- ####################################################################################################### -->
 <div id="latestnews">
<h3>Welcome To GRIET Exam Branch</h3>
...
<table width="200" border="0" align="center" cellpadding="2" cellspacing="5">
	...
	?> 
        <form action="includesexam/process_login.php" method="post" name="login_form">                  
