  ...
  <div class="rnd">
    ...
    <div id="topnav">
      <ul>
        ...
        <li class="active"><a href="extracur.php">Extra Curricular</a></li>
...
<div class="wrapper row3">
  <div class="rnd">
   ...
   <tr>
	<?php 
		$k = mysql_query("select * from otheract where id =  '$_SESSION[username]'");
    ...
    <td>Projects:</td>
    <td><?php
		$p = mysql_query("select project from otheract where id = '$_SESSION[username]'");
