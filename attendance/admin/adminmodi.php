...
<div class="wrapper row2">
  <div class="rnd">
    ...
    <div id="topnav">
      <ul>
		<li><a href="report.php">Report</a></li><li><a href="report.php">Report</a></li>
        <li><a href="updatepwd.php">Change Password</a>
        </li><li><a href="attenmodi.php">Modify</a></li>
...
<div class="wrapper row3">
  <div class="rnd">
   ...
   <form name = "adminmodi.php" action = "insertadminmodi.php" method = "POST">
    ...
    <?php
		$i = 0;
		$b = mysql_query("select * from timetable where day like '$day%' and code = '$_SESSION[dept]'");
...
?>
	    <tr>
		<td><input type = "checkbox" name = "<?php echo $j ?>"  /></td>
	    <td><input type = "text" name = "<?php echo 'year'.$j ?>" value = "<?php echo $row1['year']; ?>" /></td>
	    <td><input type = "text" name = "<?php echo 'section'.$j ?>" value = "<?php echo $row1['section']; ?>" /></td>	
	    <td><input type = "text" name = "<?php echo 'subject'.$j ?>" value = "<?php echo $row1['subject']; ?>" /></td>
	    <td><input type = "text" name = "<?php echo 'duration'.$j ?>" value = "<?php echo $row1['duration']; ?>" /></td>
    	<td><input type = "text" name = "<?php echo 'faculty'.$j?>" value = "<?php echo $row1['faculty']; ?>" /></td>
		</tr>
<?php
	}
?>
