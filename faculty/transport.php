...
<div class="wrapper row3">
  <div class="rnd">
    ...
    <?php
		$k = mysql_query("select count(*) from transport where rollno = (Select username from members where encemail = '$usr')");
   ...
   <h3>Transport:</h3> 
	...
	<?php 
		if($row1['count(*)']==0) 
			...
			$l = mysql_query("select * from transport where rollno = (Select username from members where encemail = '$usr')"); 
