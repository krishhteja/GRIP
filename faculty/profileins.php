...
sec_session_start();
	...
	while($row = mysql_fetch_array($k)){
    	...
    	$k = mysql_query("INSERT into facgen values('$_POST[id]', '$_POST[lname]', '$_POST[fname]', '$_POST[mname]',  '$_POST[dob]', '$_POST[gen]', '$_POST[sname]', '$_POST[fatname]', '$_POST[hno]', '$_POST[street]', '$_POST[village]', '$_POST[dist]', '$_POST[state]', '$_POST[pin]', '$_POST[phone1]', '$_POST[phone2]', '$_POST[email]')");
