  ...
  <div class="rnd">
    ...
    <div id="topnav">
      <ul>
        ...
        <li class = "active"><a href="notif.php">Message</a></li>
...
<form action = "notif.php?id=<?php echo $_SESSION['username']; ?>" method="post">
<?php
	//for testing do change the mentid :)
	$k = mysql_query("select * from mentorstudent where mentid = '$_SESSION[username]'");
...
<?php
	$s = mysql_query("select username from facmembers where encemail = '$usr'");
	while($row = mysql_fetch_array($s)){
		...
		if(isset($_POST['submit'])){
			...
			for($i = 0; $i < count($checked); $i++){
				$p = $_POST['notif'];
				mysql_query("insert into notif values('$checked[$i]', '$p', '$n')");
			}
		}
	}
?>
