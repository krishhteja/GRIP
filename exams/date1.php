...
if (isset($_POST['s'])){
	 {
		...
		$y=$_POST['d3'];
		$date = $y."-".$m."-".$d;
		$idat=mysql_query("SELECT * from assign where date='$date' order by fnoran desc"); 
...
<?php /*else : 
            <p>
                <span class="error">You are not authorized to access this page.</span> Please <u><a href="../examlogin.php">login</a></u>.
            </p>
        <?php endif;*/ ?>
