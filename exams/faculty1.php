...
$idat=mysql_query("SELECT * from assign where id='$fid' order by date asc, fnoran desc");
$a=mysql_query("SELECT id,name from assign where id='$fid' order by date asc, fnoran desc");
