...
<div class="wrapper row1">
  ...
  <div class="rnd">
    <!-- ###### -->
    <div id="topnav">
      <ul><li><a href="../../includesexam/logout.php">Logout</a></li>
      </ul>
	</div>        
    <!-- ###### -->
  </div>
...
Enter date in dd-mm-yyyy format<input type="text" name="d1" size="10">
<input type="text" name="d2" size="10">
...
if (isset($_POST['s'])){
	 {
		...
		$y=$_POST['d3'];
		$date = $y."-".$m."-".$d;
		$idat=mysql_query("SELECT * from assign where date='$date'"); 
?>
...
<tr> <td> ID </td>
    ...
    {
		$i=mysql_query("select deid from grietfaculty where id='$id[id]'");
		?>
