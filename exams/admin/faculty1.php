...
$idat=mysql_query("SELECT * from assign where id='$fid'");
 ...
 $a=mysql_query("SELECT id,name from assign where id='$fid'");
 ...
 ?> 
 <br> <input type="button" border = '2' onclick="tableToExcel('testTable', 'W3C Example Table')" value="Export to Excel">
